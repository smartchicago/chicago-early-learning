...
class Location(models.Model):
    ...
    def get_map_location_data(self):
        location = {
            ...
            'day_or': self.is_full_day or self.is_part_day,
            'full_day': self.is_full_day,
            'part_day': self.is_part_day,
            'week_or': self.is_full_week or self.is_part_week,
            'full_week': self.is_full_week,
            'part_week': self.is_part_week,
            'year_or': self.is_full_year or self.is_school_year,
            'full_year': self.is_full_year,
            'school_year': self.is_school_year,
